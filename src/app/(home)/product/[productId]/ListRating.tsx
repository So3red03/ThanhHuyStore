                ...
                return (
                  <div key={review.id} id={`comment-${review.id}`} className='max-w-[750px] mb-4'>
                    <div className='flex gap-2 items-center'>
                      ...
                      <div className='font-light text-gray-400'>{formatDateNoTime(review.createdDate)}</div>
                    </div>
                      ...
                      <div className='flex flex-col lg:gap-y-4 gap-y-1'>
                        ...
                        {review.reply && (
                          <div className='bg-gray-100 p-3 rounded-md'>
                            ...
                            <div className='font-light text-gray-400'>{formatDateNoTime(review?.updatedAt)}</div>
