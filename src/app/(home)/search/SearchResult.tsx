        ...
        <div className='flex items-start gap-x-10 mt-12'>
          <div>
            <div className='flex justify-between items-center mb-[20px]'>
              <h2 className='block select-none text-xl font-[600] sm:text-2xl'>Kết quả tìm kiếm ({products.length})</h2>
              <div>
                <Button
            ...
            <div className='grid w-full grid-cols-1 gap-[30px] md:mt-[0px] md:w-[220px] lg:w-[270px]'>
              <div className='w-full'>
                <div className='w-full max-w-[800px]'>
                  <h2 className='block select-none text-xl font-[600] sm:text-2xl mb-[20px]'>Bài viết liên quan</h2>
