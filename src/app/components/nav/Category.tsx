...
const Category: React.FC<CategoryProps> = ({ label, category, subItems, subItemsImg, icon, selected, onClick }) => {
      ...
      >
        <div className='flex flex-nowrap items-start justify-start mx-auto min-h-[100px] max-h-[600px]'>
          <div className='mr-[20px]'>
            <img src={subItemsImg} alt={`${label} category image`} className='max-w-[200px] max-h-[500px]' />
          </div>
